    ...
    const fetchRequests = async () => {
        try {
            ...
            const response = await fetch(
                `http://localhost:5000/api/requests/customer/${userInfo._id}`,
            );
                ...
                >
                    <div style={{ marginBottom: "25px" }}>
                        <p style={{ color: "#64748b", fontSize: "13px" }}>
                            Track and manage your custom design requests sent to designers.
                        </p>
                    </div>
                    ...
                    >
                        {filteredRequests.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <PerfectPreview
                                                    mockupSrc={
                                                        req.productImage?.startsWith("data:image")
                            ...
                            >
                                ...
                                <p style={{ color: "#64748b", fontSize: "13px" }}>
                                    Start by requesting an edit on any product page.
                                </p>
                            </div>
                        )}
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div style={{ transform: "translateX(0px) translateY(-8px)" }}>
                                    <PerfectPreview
                                        mockupSrc={
                                            selectedRequest.productImage?.startsWith("data:image")
                                                ? "/img/womenfront-mockup.png"
                            ...
                            {selectedRequest.status === "Completed" ? (
                                <>
                                    ...
                                    <button
                                        onClick={() => {
                                            alert(
                                                "Proceeding to checkout with your custom design...",
                                            );
                                            navigate("/checkout", {
                                ...
                                <>
                                    ...
                                    >
                                        Communication with the designer will be enabled once the
                                        request is accepted.
                                    </p>
                                    <button
                                        disabled
