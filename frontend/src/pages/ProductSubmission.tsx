...
const ProductSubmission = () => {
  ...
  const {
    ...
    // Design Snapshots
    frontDesign = location.state?.frontDesign ||
    fallbackSnapshots.frontDesign ||
    "",
    backDesign = location.state?.backDesign ||
    fallbackSnapshots.backDesign ||
    "",
    neckDesign = location.state?.neckDesign ||
    fallbackSnapshots.neckDesign ||
    "",
    foldedDesign = location.state?.foldedDesign ||
    fallbackSnapshots.foldedDesign ||
    "",
    ...
    frontPrintArea: passedFrontPrintArea = {
      top: "50%",
      left: "51%",
      width: "30%",
      height: "27%",
  ...
  const frontPrintArea = { ...passedFrontPrintArea, top: "50%" };
  ...
  const LoadingOverlay = () => (
    ...
    >
      ...
      <p style={{ color: "#64748b", fontSize: "14px", marginTop: "8px" }}>
        Uploading high-resolution design assets
      </p>
      <style>{`
      ...
      <div className="main-content">
        ...
        >
          <div style={blueCardStyle}>
            <h3 style={{ color: "#0d375b", marginBottom: "15px" }}>
            ...
            />
            <label style={{ ...largeLabelStyle, marginTop: "20px" }}>
              Description
            </label>
            <div
              className="admin-specs-box"
              dangerouslySetInnerHTML={{ __html: ADMIN_SPECS }}
            />
            <div
              style={{
                background: "white",
            ...
            >
              <ReactQuill
                ...
                onChange={(val: string) =>
                  handleInputChange("designDescription", val)
                }
              />
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("allowCustomization", e.target.checked)
                    }
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: formData.allowCustomization
                        ? "#0d375b"
                        : "#ccc",
                      transition: ".4s",
                      borderRadius: "34px",
                  ...
                  <span
                    style={{
                      ...
                      height: "18px",
                      width: "18px",
                      left: formData.allowCustomization ? "23px" : "3px",
                      bottom: "3px",
                ...
                <div>
                  ...
                  <div style={{ color: "#555", fontSize: "12px" }}>
                    Users can use the Live Editor for small edits.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <input
                    type="checkbox"
                    checked={formData.allowEditRequests}
                    onChange={(e) =>
                      handleInputChange("allowEditRequests", e.target.checked)
                    }
                    style={{ opacity: 0, width: 0, height: 0 }}
                  />
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: formData.allowEditRequests
                        ? "#0d375b"
                        : "#ccc",
                      transition: ".4s",
                      borderRadius: "34px",
                  ...
                  <span
                    style={{
                      ...
                      height: "18px",
                      width: "18px",
                      left: formData.allowEditRequests ? "23px" : "3px",
                      bottom: "3px",
                      backgroundColor: "white",
                      transition: ".4s",
                      borderRadius: "50%",
                ...
                <div>
                  <div style={{ fontWeight: "700", fontSize: "14px" }}>
                    Allow Designer-Handled Edit Requests
                  </div>
                  <div style={{ color: "#555", fontSize: "12px" }}>
                    Users can request custom edits through you.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div style={blueCardStyle}>
            ...
            >
              <div style={{ flex: 1 }}>
                <h3 style={{ color: "#0d375b", marginBottom: "20px" }}>
                  Pricing Setup
                </h3>
                ...
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "200px 20px 1fr",
                    gap: "10px",
                    marginTop: "20px",
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "24px",
                background:
                  formData.title && !isSubmitting ? "#0d375b" : "#94a3b8",
                color: "white",
                fontWeight: "900",
                cursor:
                  formData.title && !isSubmitting ? "pointer" : "not-allowed",
                display: "flex",
                alignItems: "center",
                gap: "8px",
              }}
            ...
            <button
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 6px 20px rgba(13, 55, 91, 0.3)";
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 4px 12px rgba(13, 55, 91, 0.25)";
              }}
            >
              Go to My Shop
            </button>
...
const PerfectPreview = ({
  ...
  // We force the component to think it is inside the original Design Tool
  const ORIGINAL_WIDTH = 550;
  const ORIGINAL_HEIGHT = 800;

  // Calculate exactly how much to shrink the whole container
  ...
  return (
    ...
    >
      {/* 🟢 THE SHRINK RAY: This box is exactly 550x800, but scales down perfectly */}
      <div
        style={{
      ...
      >
        ...
        {/* 3. FLATTENED DESIGN ONLY. NO TEXT COMPONENTS. */}
        <div
          style={{
            position: "absolute",
            top: "-100px",
          ...
          >
            <div
              style={{
                ...
                marginLeft: `calc(-1 * ${printArea?.width} / 2)`,
                marginTop: `calc(-1 * ${printArea?.height} / 2)`,
                transform: `rotate(${printArea?.rotation ?? 0}deg)`,
              }}
            >
              {/* 🚀 JUST THE PNG: Dropped perfectly into the print boundaries */}
              {frontDesign && (
                <img
                  src={frontDesign}
                  alt="Design Layout"
