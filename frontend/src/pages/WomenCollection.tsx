            ...
            <div key={item.id} className="product-card" style={{ background: 'white', padding: '15px', borderRadius: '24px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9', transition: 'all 0.3s ease', width: '100%', position: 'relative' }}>
                ...
                <div 
                    ...
                    style={{ 
                        ...
                        overflow: 'hidden', 
                        cursor: 'pointer',
                        padding: '15px' // Added padding to ensure no T-shirt touches the edge
                    }}
                >
                    <img 
                        src={item.img} 
                ...
                <div style={{ padding: '0 10px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', borderTop: '1px solid #f1f5f9', paddingTop: '12px', gap: '15px' }}>
                        <div onClick={(e) => { e.stopPropagation(); }} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '5px' }}>
                            <img src="/img/heart.png" alt="" style={{ width: '18px', opacity: 0.7 }} />
                            <span style={{ fontSize: '12px', color: '#64748b', fontWeight: '600' }}>{item.likes || 0}</span>
                        </div>
                        <img src="/img/cart.png" alt="" style={{ width: '18px', opacity: 0.7 }} />
                        <span style={{ fontSize: '12px', color: '#64748b', fontWeight: '600' }}>{item.sales || 0}</span>
                    </div>
                </div>
            </div>
        );
