...
const WomenCollection = () => {
    ...
    const getProcessedProducts = () => {
        // COMBINING ORIGINAL MOCK DATA + REAL DESIGNER PRODUCTS
                    ...
                    <div style={{ padding: '0 30px 40px 30px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', padding: '5px 3px', borderBottom: '1px solid #f1f5f9' }}>
                            ...
                            <div style={{ display: 'flex', gap: '8px' }}>
                                <div style={{ position: 'relative' }}>
                                    ...
                                    {filterOpen && (
                                        <div style={{ position: 'absolute', top: '40px', right: 0, width: '180px', background: 'white', borderRadius: '12px', boxShadow: '0 10px 30px rgba(13, 55, 91, 0.15)', padding: '12px', zIndex: 100, border: '1px solid #e2e8f0' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px' }}>
                            {displayProducts.map((item: any) => {
                                //  LIVE CART SYNC: Findin current quantity in cart context
