    ...
    const handleConfirmPayment = async () => {
        ...
        setTimeout(async () => {
            try {
                ...
                const { data } = await axios.post('http://localhost:5000/api/orders', finalOrderData, config);
                    ...
                    {step === 1 && (
                        <div className="animate-fade-in">
                            <div style={amountSection}>
                                ...
                                <h1 style={amountText}>LKR {totalAmount?.toLocaleString()}.00</h1>
                            </div>
...
const cardHeader: React.CSSProperties = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px', borderBottom: '1px solid #f1f5f9', paddingBottom: '20px' };
const secureText: React.CSSProperties = { fontSize: '18px', fontWeight: '800', color: '#0d375b' };

const amountSection: React.CSSProperties = { background: '#f8fafc', padding: '25px', borderRadius: '16px', marginBottom: '30px', textAlign: 'center' };
const label: React.CSSProperties = { fontSize: '13px', color: '#64748b', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: '700' };
const amountText: React.CSSProperties = { fontSize: '36px', fontWeight: '900', color: '#0d375b', margin: '5px 0 0 0' };

const formGroup: React.CSSProperties = { marginBottom: '20px' };
const inputLabel: React.CSSProperties = { display: 'block', fontSize: '13px', fontWeight: '700', color: '#475569', marginBottom: '8px' };
const inputField: React.CSSProperties = { width: '100%', padding: '15px', borderRadius: '12px', border: '1.5px solid #e2e8f0', background: '#f8fafc', fontSize: '16px', fontWeight: '600', color: '#334155' };

const primaryBtn: React.CSSProperties = { width: '100%', padding: '18px', borderRadius: '12px', background: '#0d375b', color: 'white', border: 'none', fontSize: '18px', fontWeight: '800', cursor: 'pointer', transition: 'all 0.3s' };
const backBtn: React.CSSProperties = { width: '100%', background: 'none', border: 'none', color: '#64748b', fontSize: '14px', fontWeight: '600', marginTop: '15px', cursor: 'pointer', textDecoration: 'underline' };

const stepTitle: React.CSSProperties = { fontSize: '24px', fontWeight: '900', color: '#0d375b', marginBottom: '10px' };
const stepDesc: React.CSSProperties = { fontSize: '15px', color: '#64748b', lineHeight: '1.5' };
const otpInput: React.CSSProperties = { width: '200px', textAlign: 'center', fontSize: '32px', fontWeight: '800', letterSpacing: '10px', padding: '15px', borderRadius: '12px', border: '2px solid #0d375b', color: '#0d375b' };

const processingWrapper: React.CSSProperties = { display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '60px 0' };
const spinner: React.CSSProperties = { marginBottom: '30px' };
const processingTitle: React.CSSProperties = { fontSize: '22px', fontWeight: '900', color: '#0d375b', marginBottom: '10px' };
const processingDesc: React.CSSProperties = { fontSize: '14px', color: '#64748b', textAlign: 'center', maxWidth: '300px', lineHeight: '1.6' };

const summaryTitle: React.CSSProperties = { fontSize: '18px', fontWeight: '800', color: '#0d375b', marginBottom: '25px', borderBottom: '1px solid #f1f5f9', paddingBottom: '15px' };
const summaryContent: React.CSSProperties = { display: 'flex', flexDirection: 'column', gap: '20px' };
const summaryRow: React.CSSProperties = { display: 'flex', justifyContent: 'space-between', alignItems: 'center' };
const thumb: React.CSSProperties = { width: '60px', height: '60px', borderRadius: '10px', objectFit: 'contain', background: '#f8fafc', border: '1px solid #f1f5f9' };
const itemTitle: React.CSSProperties = { fontSize: '14px', fontWeight: '700', color: '#334155', margin: 0 };
const itemMeta: React.CSSProperties = { fontSize: '12px', color: '#64748b' };
const itemPrice: React.CSSProperties = { fontSize: '14px', fontWeight: '800', color: '#0d375b' };
const divider: React.CSSProperties = { height: '1px', background: '#f1f5f9', margin: '10px 0' };
const totalRow: React.CSSProperties = { display: 'flex', justifyContent: 'space-between', fontSize: '18px', fontWeight: '900', color: '#0d375b' };
const noteText: React.CSSProperties = { textAlign: 'center', fontSize: '12px', color: '#94a3b8', marginTop: '20px', fontStyle: 'italic' };
