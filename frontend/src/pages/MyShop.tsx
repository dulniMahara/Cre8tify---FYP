...
const formatDescription = (desc?: string) => {
    if (!desc)
        return "This uniquely crafted t-shirt blends comfort with expressive design, created to match a wide range of personal styles.";
    ...
    if (specsPart) {
        let html = specsPart.replace(
            "🛠 Product Specifications & Quality Assurance",
            '<div style="margin-bottom: 6px;"><strong style="color: #0d375b; font-size: 11px; display: block; margin-bottom: 4px;">🛠 Product Specifications & Quality Assurance</strong>',
        );
        html = html.replace(
...
const MyShop = () => {
                ...
                setDesignerInfo({
                    ...
                    profileImg: user.profileImage
                        ? user.profileImage.startsWith("http")
                            ? user.profileImage
                            : `${API_URL}${user.profileImage.startsWith("/") ? "" : "/"}${user.profileImage}`
                        : "/img/profile-picture.png",
                    bio:
                        user.bio ||
                        "Passionate about creating unique and expressive designs for the modern generation.",
                });
            } catch (e) {
    ...
    const hardcodedDesigns: DesignItem[] = [
        {
            ...
            scale: 1.3,
            description:
                "A minimal abstract representation of the Spider Lily flower, symbolizing memory and transformation. Perfect for casual streetwear.",
        },
        {
            id: 2,
            title: "Dark Moon Phase",
            price: 1450,
            image: "/img/shop2.png",
            status: "Approved",
            updatedDate: "11 Oct 2025",
            ...
            scale: 0.9,
            description:
                "Detailed lunar cycle illustration on a dark aesthetic background. High-quality print suitable for night outs.",
        },
        {
            id: 3,
            title: "Evangelion Retro",
            price: 1450,
            image: "/img/shop3.png",
            status: "Approved",
            updatedDate: "11 Oct 2025",
            ...
            scale: 1.0,
            description:
                "Retro anime style graphic featuring iconic mecha elements. A tribute to 90s classic animation.",
        },
        {
            id: 4,
            title: "Wave Aesthetic",
            price: 1450,
            image: "/img/shop4.png",
            status: "Submitted",
            ...
            scale: 1.2,
            description:
                "Blue wave patterns inspired by Japanese woodblock prints. Calming and artistic.",
        },
        {
            id: 5,
        ...
        },
        {
            ...
            rejectionReason:
                "Image resolution is too low (72 DPI). We require at least 300 DPI for printing. Please upload a higher quality file.",
        },
    ];
            ...
            try {
                ...
                const formattedDB = data.map((item: any) => ({
                    ...
                    image:
                        item.mockupImages && item.mockupImages.length > 0
                            ? item.mockupImages[0].startsWith("/uploads")
                                ...
                                : item.mockupImages[0]
                            : "/img/shop1.png", // Take first mockup
                    ...
                    frontDesign: item.frontDesign
                        ? item.frontDesign.startsWith("/uploads")
                            ? `http://localhost:5000${item.frontDesign}`
                            : item.frontDesign
                        : null,
    ...
    const filteredDesigns = allDesigns.filter((design) => {
        const matchesTab =
            activeTab === "All" ||
            design.status === activeTab ||
            (activeTab === "Pending" && design.status === "Submitted");
    ...
    return (
        <div className="dashboard-container">
            ...
            <style>
                @import
                url('https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Outfit:wght@100..900&display=swap');
                {`
            ...
            >
                ...
                >
                    ...
                    >
                        {["All", "Submitted", "Approved", "Rejected", "Draft"].map(
                            (tab) => (
                                <button
                                    key={tab}
                        ...
                        {filteredDesigns.map((design) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src={getStatusIcon(design.status)}
                                            alt={design.status}
                                        ...
                                        {!design.frontDesign ? (
                                            ...
                                            >
                                                <PerfectPreview
                                                    ...
                                                    containerWidth={
                                                        160
                                                    } /* 🚀 Perfectly shrinks to fit the grid card */
                                                />
                                            </div>
                                        )}
                                    </div>
                                ...
                                >
                                    ...
                                    >
                                        LKR {design.price.toLocaleString()}
                                    </div>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        🛍️ Sales: {design.sales.toString().padStart(2, "0")}
                                    </span>
                                </div>
                                        ...
                                        <button
                                            onClick={() =>
                                                setRejectionPopup({
                                                    show: true,
                                                    reason:
                                                        design.rejectionReason || "No reason provided.",
                                                })
                                            }
                                            style={{
                                                flex: 1,
                ...
                >
                    <div
                        style={{
                            ...
                            padding: "20px",
                            borderRadius: "12px",
                            boxShadow: "0 13px 25px -6px rgba(0, 0, 0, 0.25)",
                ...
                >
                    ...
                    >
                                ...
                                {!previewPopup.frontDesign ? (
                                    ...
                                    >
                                        <PerfectPreview
                                            ...
                                            frontDesign={previewPopup.frontDesign}
                                            containerWidth={
                                                320
                                            } /* 🚀 Scales up to fit the larger popup modal */
                                        />
                                    </div>
                                )}
                            </div>
                        ...
                        <div
                            ...
                            style={{ flex: 1, padding: "25px", overflowY: "auto" }}
                        >
                            <h1
                                style={{
                                    fontFamily: '"Outfit", sans-serif',
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                >
                                    LKR {previewPopup.price.toLocaleString()}.00
                                </div>
                                <div
                                    style={{
                                        fontSize: "7px",
                                ...
                                >
                                    Base: 850 | Designer: {previewPopup.price - 1100} | Service:
                                    250
                                </div>
                            </div>
                            ...
                            <div style={{ marginBottom: "15px" }}>
                                ...
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{
                                        __html: formatDescription(previewPopup.description),
                                    }}
                                />
                            </div>
                                    ...
                                    {VARIANT_COLORS.map((c) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                boxShadow:
                                                    selectedColor === c.hex
                                                        ? "0 0 0 1px white, 0 0 0 2px #0f172a"
                                                        : "none",
                                                transition: "all 0.2s",
...
const ActionButton = ({
    ...
    <button
        onClick={onClick}
        style={{
            background: isDestructive ? "#fff1f2" : "#f0f9ff",
            color: isDestructive ? "#be123c" : "#0369a1",
            border: `1px solid ${isDestructive ? "#fecdd3" : "#bae6fd"}`,
            padding: "5px 0",
            borderRadius: "6px",
            fontSize: "6px",
            cursor: "pointer",
        ...
        onMouseOver={(e) => {
            e.currentTarget.style.background = isDestructive ? "#ffe4e6" : "#e0f2fe";
        }}
        onMouseOut={(e) => {
            e.currentTarget.style.background = isDestructive ? "#fff1f2" : "#f0f9ff";
        }}
    >
        {text}
    </button>
