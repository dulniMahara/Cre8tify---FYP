                            ...
                            {displayProducts.map((item: any) => {
                                ...
                                return (
                                    <div key={item.id} className="product-card" style={{ background: 'white', padding: '8px', borderRadius: '12px', boxShadow: '0 2px 10px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9', width: '100%', position: 'relative' }}>
                                        <div onClick={handleNavigate} style={{ background: '#f8fafc', borderRadius: '9px', display: 'flex', justifyContent: 'center', marginBottom: '8px', height: '170px', alignItems: 'center', overflow: 'hidden', cursor: 'pointer' }}>
...
// ... Sub-components (FilterButton, DropdownItem, PaginationBtn) remain the same ...
