...
const MenCollection = () => {
    ...
    //  1. Grab the context for Cart Sync
    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="main-content" style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <div className="content-wrapper collection-content" style={{ padding: '0', overflowX: 'hidden', background: '#f8fafc', marginTop: '70px' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', padding: '5px 3px', borderBottom: '1px solid #f1f5f9' }}>
                            ...
                            <div style={{ display: 'flex', gap: '8px' }}>
                                <div style={{ position: 'relative' }}>
                                    <FilterButton text={filterBy === 'All' ? "Filter" : filterBy} onClick={() => { setFilterOpen(!filterOpen); setSortOpen(false); }} active={filterOpen || filterBy !== 'All'} />
                                    {filterOpen && (
                                        <div style={{ position: 'absolute', top: '40px', right: 0, width: '180px', background: 'white', borderRadius: '12px', boxShadow: '0 10px 30px rgba(13, 55, 91, 0.18)', padding: '12px', zIndex: 100, border: '1px solid #e2e8f0' }}>
                                ...
                                <div style={{ position: 'relative' }}>
                                    <FilterButton text={`Sort: ${sortBy}`} onClick={() => { setSortOpen(!sortOpen); setFilterOpen(false); }} active={sortOpen} />
                                    {sortOpen && (
                                        <div style={{ position: 'absolute', top: '40px', right: 0, width: '180px', background: 'white', borderRadius: '12px', boxShadow: '0 10px 30px rgba(13, 55, 91, 0.18)', padding: '10px', zIndex: 100, border: '1px solid #e2e8f0' }}>
...
const DropdownItem = ({ text, onClick }: any) => (
    <div onClick={onClick} className="dropdown-item-hover" style={{ padding: '10px 15px', borderRadius: '8px', fontSize: '13px', color: '#334155', cursor: 'pointer', fontWeight: '600', transition: 'all 0.2s' }}>{text}</div>
);
