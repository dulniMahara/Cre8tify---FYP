...
const KidsCollection = () => {
    ...
    const getFiltered = (gender: string) => {
        let items = kidsProducts.filter(p => p.gender === gender);
                        ...
                        <div style={{ marginBottom: '80px' }}>
                            ...
                            <div style={productGridStyle}>
                                {girlsList.slice(0, visibleGirls).map((item: any) => (
                                    <ProductCard key={item.id} item={item} likedProducts={likedProducts} toggleLike={toggleLike} color="#db2777" />
                                ))}
                            </div>
                        ...
                        <div style={{ marginBottom: '80px' }}>
                            ...
                            <div style={productGridStyle}>
                                {boysList.slice(0, visibleBoys).map((item: any) => (
                                    <ProductCard key={item.id} item={item} likedProducts={likedProducts} toggleLike={toggleLike} color="#0284c7" />
                                ))}
                            </div>
...
const ProductCard = ({ item, likedProducts, toggleLike, color }: any) => (
    <div className="product-card" style={productCardMain}>
        ...
        <div style={cardFooterStyle}>
            <div style={{ fontSize: '18px', fontWeight: '900', color: '#ef4444' }}>LKR {item.price.toLocaleString()}</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                    <img src="/img/shopping-cart.png" alt="" style={{ width: '18px', opacity: 0.6 }} />
                    <span style={{ fontSize: '12px', color: '#64748b', fontWeight: '700' }}>{item.sales}</span>
                </div>
            </div>
        </div>
    </div>
